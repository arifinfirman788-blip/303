        ...
        <div className="space-y-32">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch bg-secondary-50 p-8 rounded-3xl border border-secondary-100">
              ...
              >
                <div className="w-[300px] h-[640px] rounded-2xl shadow-xl overflow-hidden bg-white border border-secondary-200 relative">
                   <div className="w-[375px] h-[800px] absolute top-0 left-0 origin-top-left scale-[0.8] overflow-hidden">
                      <iframe 
